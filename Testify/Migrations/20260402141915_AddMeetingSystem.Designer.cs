...
namespace Testify.Migrations
{
    ...
    [Migration("20260402141915_AddMeetingSystem")]
    partial class AddMeetingSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Testify.Entities.PrintBacklog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PrintBacklogs");
                });

            modelBuilder.Entity("Testify.Entities.PrintBacklogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PrintBacklogId");

                    b.HasIndex("ProductBacklogItemId");

                    b.ToTable("PrintBacklogItems");
                });

            modelBuilder.Entity("Testify.Entities.ProductBacklogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Testify.Entities.PrintBacklogItem", b =>
                {
                    ...
                    b.HasOne("Testify.Entities.PrintBacklog", "PrintBacklog")
                        .WithMany("Items")
                        .HasForeignKey("PrintBacklogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Testify.Entities.ProductBacklogItem", "ProductBacklogItem")
                        .WithMany("PrintBacklogItems")
                        .HasForeignKey("ProductBacklogItemId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("Assignee");

                    b.Navigation("PrintBacklog");
            ...
            modelBuilder.Entity("Testify.Entities.TemplateCategory", b =>
                {
                    b.HasOne("Testify.Entities.TemplateCategory", "ParentCategory")
            ...
            modelBuilder.Entity("Testify.Entities.ProductBacklogItem", b =>
                {
                    b.Navigation("PrintBacklogItems");
                });
